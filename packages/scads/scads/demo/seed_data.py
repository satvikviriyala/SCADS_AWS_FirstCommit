...
def _reference_profile(
    ...
    return ReferenceProfile(
        ...
        stable_rois=[
            ...
            RoiSpec("warning_strip", 0.04, 0.58, 0.60, 0.12, weight=0.8),
            # Excluded from structural comparison.
            RoiSpec("batch_overprint", 0.62, 0.62, 0.34, 0.16, dynamic=True),
            RoiSpec("qr_zone", 0.66, 0.30, 0.28, 0.28, dynamic=True),
        ],
...
REFERENCE_A = ReferenceProfile(
    **{
        **_reference_profile("ref_demo_a", "sku_demo_a", "CARTON_FRONT_v1", 900 / 520).__dict__,
        "ocr_anchors": [
            OcrAnchor("brand", "PARACETAMOL", 0.235, 0.135),
            OcrAnchor("strength", "500", 0.105, 0.475),
            OcrAnchor("form", "TABLETS", 0.215, 0.345),
            OcrAnchor("manufacturer", "DEMO", 0.105, 0.800),
            OcrAnchor("warning", "PRESCRIPTION", 0.230, 0.630),
        ],
    }
)

REFERENCE_B = ReferenceProfile(
    **{
        **_reference_profile("ref_demo_b", "sku_demo_b", "CARTON_FRONT_v1", 900 / 520).__dict__,
        "ocr_anchors": [
            OcrAnchor("brand", "AMOXICILLIN", 0.235, 0.135),
            OcrAnchor("strength", "250", 0.105, 0.475),
            OcrAnchor("form", "CAPSULES", 0.215, 0.345),
            OcrAnchor("manufacturer", "DEMO", 0.105, 0.800),
            OcrAnchor("warning", "PRESCRIPTION", 0.230, 0.630),
        ],
    }
...
REFERENCE_PROFILES = [REFERENCE_A, REFERENCE_B]
